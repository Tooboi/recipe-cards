          ...
          {initialRecipes.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 sm:gap-6 gap-2 px-4 w-full sm:w-max">
              {initialRecipes.map((recipe) => (
                ...
                >
                  <div className="sm:h-full flex sm:hidden flex-col border-2 border-slate-600 overflow-hidden rounded-md bg-slate-300 hover:bg-slate-200 transition-colors group shadow-md hover:shadow-lg">
                    <div className="flex flex-row">
                      <div className="w-1/4">
                        {recipe.imageId && recipe.imageId.length > 0 ? (
                          <div className="h-full w-full flex ">
                            <div className="overflow-hidden mx-auto">
                              <CldImage
                                ...
                                aspectRatio="1:1"
                                sizes="100vw"
                                className="mx-auto w-full h-full border-r-2 group-hover:brightness-110 transition-all border-slate-600 overflow-hidden"
                              />
                            </div>
                          </div>
                        ) : (
                          <div className="bg-slate-400/50 h-full flex w-full">
                            <Image
                              className="w-full h-full grow border-r-2 border-slate-600 "
                              width={100}
                              height={100}
                              unoptimized
                      ...
                      <div className=" w-3/4 flex flex-col ">
                        <div className="pl-2  bg-slate-200 border-b-2 border-slate-600 h-1/2">
                          <div className="flex flex-col ">
                  ...
                  <div className="hidden sm:h-full sm:flex flex-col border-2 border-slate-600 overflow-hidden rounded-md bg-slate-300 hover:bg-slate-200 transition-colors group shadow-md hover:shadow-lg">
                    <div className=" flex justify-between items-start p-2">
                      ...
                      >
                        {bookmarks[recipe.id] ? (
                          ...
                          <BookmarkSolidIcon className="w-9 h-10 text-slate-700 bg-slate-400 hover:text-amber-900 hover:stroke-2 hover:stroke-amber-600 hover:infill-amber-500 rounded-sm p-1 transition-all active:scale-95 active:drop-shadow-none drop-shadow-sm" />
                        )}
                      </button> */}
                    </div>
                    <div className="relative h-full">
                      ...
                      {/* <button
                        ...
                        className="absolute top-2 right-2 p-2 rounded-sm bg-yellow-600 border-2 border-slate-700 hover:bg-slate-800"
                      >
