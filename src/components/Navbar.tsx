    ...
    <div className="bg-slate-300 px-2 border-b-2 border-slate-800 shadow-md z-100 top-0 sticky h-12">
      <div className="flex my-auto flex-row justify-between gap-4 content-center h-full">
        ...
        <div className="flex flex-row  my-auto">
          <div className="flex">
            <Link className="px-2 py1 mr-2 mt-0.5 h-max bg-slate-400 hover:bg-slate-300 sm:block hidden rounded-sm" href={'/new-recipe'}>
              New Recipe
            </Link>
            <Link className="px-2 py1 mr-2 mt-0.5 h-max bg-slate-400 hover:bg-slate-300 sm:hidden block rounded-sm" href={'/new-recipe'}>
              New
            </Link>
